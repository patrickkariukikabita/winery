                        ...
                        <ul class="navbar-nav">
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                              ...
                              <li><a class="dropdown-item text-danger logoutbtn" href="#">Logout</a></li>
                            </ul>
                          </li>
                        </ul>
                      </div>
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <form class="createAccountForm" method="POST">
                         <div class="mb-3">
                             <input type="text" id="" class="form-control email" placeholder="enter email" required name="email">
                                   </div>
                                   <div class="mb-3">
                             <input type="text" id="" class="form-control phone" placeholder="enter phone number" name="phone">
                                   </div>
                         <div class="mb-3">
                             <input type="text" id="" class="form-control username" placeholder="enter username" required name="username">
                                   </div>
                             <div class="mb-3">
                 ...
                 <div class="modal-footer justify-content-between">
                     <button type="button" class="btn btn-secondary createClose " data-bs-dismiss="modal">Close</button>
